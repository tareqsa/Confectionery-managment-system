...
public class IncomePeriodReport 
{
	public  IncomePeriodReport(ResultSet rs) 
	{
	...
	catch (Exception e)
	{
		...
		//----------------------------------------------------------------------------------------------------------------------
			try
			{
				...
				PdfWriter writer = PdfWriter.getInstance(document,new FileOutputStream(url + "IncomePeriodReport.pdf"));
				...
				subjectCell.addElement(new Phrase("דוח הכנסות תקופתי",Fonts.Arial14BoldItalic));
				...
				//second cell
				Paragraph p2 = new Paragraph("שם פרטי",Fonts.Arial);
				...
				//third cell
				Paragraph p3 = new Paragraph("שם משפחה",Fonts.Arial);
				...
				//5th cell
				Paragraph p5 = new Paragraph("עלות",Fonts.Arial);
				...
				beforelastCell = new PdfPCell();
				beforelastCell.addElement(new Phrase(String.valueOf(Math.round(allValueAfterTax*100.0)/100.0),Fonts.Arial14Bold));
				beforelastCell.setBorder(com.itextpdf.text.Rectangle.NO_BORDER);
				beforelastTable.addCell(beforelastCell);
